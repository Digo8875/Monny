		...
		<div class='row' style='margin-top: 20px'>
			<?php
		    	echo"<div class='col-lg-5 fundo-divs rounded' style='margin-bottom:10px; font-size: 24px'>";
		    			echo ((isset($obj['Id'])) ? 'Editar Responsável' : 'Novo Responsável');
				echo "</div>";
		    ?>
			<div class='col-lg-12 rounded fundo-divs'>
				<?php echo form_open('responsavel/formCreateEdit'); ?>
						...
						<div class='checkbox checbox-switch switch-success custom-controls-stacked'>
							<?php
								...
								echo"<label for='ativo' >";
									echo "<input type='checkbox' $checked id='ativo' name='ativo' value='1' /><span></span> Responsável ativo";
								echo"</label>";
							?>
						</div>
					</div>
